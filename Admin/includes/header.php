    ...
    <nav class="col-sm-2 col-md-3 col-lg-2 bg-gray sidebar py-5 d-print-none"> <!-- Side Bar 1st Column -->
        <div class="sidebar-sticky">
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link <?php if(PAGE == 'changepass'){echo 'active';} ?>" href="changepass.php"><i class="fas fa-chart-bar" style= "margin-right: 10px;"> </i>Profile</a></li>
                <li class="nav-item"><a class="nav-link <?php if(PAGE == 'latestreading'){echo 'active';} ?>" href="latestreading.php"><i class="fas fa-chart-bar" style= "margin-right: 10px;"> </i>Latest Record</a></li>
